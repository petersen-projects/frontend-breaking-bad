...
describe('charactersReducer tests', () => {
   it('should setup default data', () => {
      const state = charactersReducer(undefined, { type: '@@INIT' });
      expect(state).toEqual(defaultState);
   });
   
   it(`${GET_CHARACTERS_REQUEST_BEGIN} - should set fetching to true`, () => {
   ...
   it(`${GET_CHARACTERS_REQUEST_ERROR} - should set fetching to false`, () => {
      const state = charactersReducer(undefined, { type: GET_CHARACTERS_REQUEST_ERROR });
      expect(state).toEqual(defaultState)
   });
   
   it(`${GET_CHARACTERS_REQUEST_SUCCESS} - should set fetch do false and set data to received value`, () => {
   ...
   it(`${SET_CHARACTERS_NUMBER_OF_PAGES} - should set numberOfPages to received value`, () => {
   ...
   it(`${SET_CHARACTERS_OFFSET} - should set offset to received value`, () => {
      const offset = 5;
   ...
   it(`${SET_CHARACTERS_DATA} - should set numberOfPages to received value`, () => {
      const numberOfPages = 5;
      const state = charactersReducer(undefined, { type: SET_CHARACTERS_NUMBER_OF_PAGES, numberOfPages });
      expect(state).toEqual({
         ...defaultState,
   ...
   it(`${SET_CHARACTERS_FILTERED_DATA} - should set filteredData to received value`, () => {
   ...
   it(`${RESET_CHARACTERS_OFFSET} - should reset offset`, () => {
   ...
   it(`${RESET_CHARACTERS_FILTERED_DATA} - should reset filteredData`, () => {
